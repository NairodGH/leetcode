...
class Solution(object):
    ...
    def multiply(self, num1: str, num2: str) -> str:
        # init big enough result array, easier to reverse before/after, sum multiplication of each num1 digit by each num2 digit with carry overs, remove leading 0s
        if num1 == "0" or num2 == "0":
            return "0"
